...
public class MyEventWaitingModel {
    ...
    public MyEventWaitingModel(String imageUrl, int idRegis,int idTour,int status, String namaTour, String jenis, String tglTour, String tglDaftar,
