...
public class MyEventTourModel {
    ...
    public MyEventTourModel(String imageUrl, int idRegis,int idTour,int idGame,int status, String namaTour, String jenis,
                            String tempat, String tglTour, String tglDaftar,
                            String tglTM, int biaya, int hadiah, String namaTim, String usrKetua, String usrAng1,
