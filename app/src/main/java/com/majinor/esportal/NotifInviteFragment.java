 ...
 */
public class NotifInviteFragment extends Fragment {
...
//    public static final String EXTRA_IGNANG4 ="ignusr4" ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_notif_invite, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.rv_notifinvite);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity() ));
        recyclerView.setHasFixedSize(true);

        adapter = new NotifInviteAdapter(arrayList);
        ...
        NotifInviteBackgroundTask NotifInviteBackgroundTask = new NotifInviteBackgroundTask
                (getActivity(),adapter,arrayList, username);
        NotifInviteBackgroundTask.execute();
