 ...
 */
public class MyEventTourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_my_event_tour, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.rv_met);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity() ));
        recyclerView.setHasFixedSize(true);

        adapter = new MyEventTourAdapter(arrayList);
        ...
        MyEventTourBackgroundTask myEventTourBackgroundTask = new MyEventTourBackgroundTask
                (getActivity(),adapter,arrayList, username);
        myEventTourBackgroundTask.execute();
